  ...
  return (
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto px-4 py-8">
            ...
            <div>
              ...
              {receiptData.restaurant_info?.date && (
                <p className="text-gray-500 text-xs mt-1">
                  {receiptData.restaurant_info.date} {receiptData.restaurant_info.time ? `• ${receiptData.restaurant_info.time}` : ''}
                </p>
              )}
            </div>
        ...
        {/* Users */}
        <GlassCard className="p-4" variant="medium" colorAccent="purple" glowEffect>
          ...
          <Dialog open={isAddingUser} onOpenChange={setIsAddingUser}>
            ...
            <DialogContent className="sm:max-w-[425px] rounded-2xl p-6 glass-frost border-white/30">
              <DialogHeader className="mb-4">
                <DialogTitle className="text-2xl font-bold text-gradient-aurora">Tambah Peserta</DialogTitle>
              ...
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Input
                    ...
                    className="col-span-3 input-aurora"
              ...
              <DialogFooter className="flex justify-end gap-2">
                ...
                <Button type="submit" onClick={handleAddUser} className="btn-aurora">
                  Tambah
                </Button>
              </DialogFooter>
            </DialogContent>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-gradient-aurora">Item yang Dipesan</h2>
          ...
          <Dialog open={isAddingManualItem} onOpenChange={setIsAddingManualItem}>
            ...
            <DialogContent className="sm:max-w-[425px] rounded-2xl p-6 glass-frost border-white/30">
              <DialogHeader className="mb-4">
                <DialogTitle className="text-2xl font-bold text-gradient-aurora">Tambah Item Baru</DialogTitle>
                <DialogDescription className="text-gray-600">
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <div className="col-span-3 py-2 px-3 rounded-md bg-white/20 backdrop-blur-md border border-white/30 text-gray-700">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <select
                    ...
                    className="col-span-3 bg-white/20 backdrop-blur-md border border-white/30 py-2 px-3 rounded-md"
                    aria-label="Kategori Item"
                  >
                    <option value="main_course">🍽️ Makanan Utama</option>
              ...
              <DialogFooter className="flex justify-end gap-2">
                ...
                <Button type="submit" onClick={handleAddManualItem} className="btn-aurora">
                  Tambah Item
                </Button>
              </DialogFooter>
            </DialogContent>
            ...
            {items.map((item, index) => (
              ...
              >
                <GlassCard 
                  className="p-4" 
                  variant="light" 
                  colorAccent={item.sharing_potential && item.sharing_potential > 0.5 ? "cyan" : "none"}
                  glowEffect={item.id.startsWith('manual-item')}
                >
                  <div className="space-y-4">
                    {/* Item Header */}
                        ...
                        <div>
                          <div className="flex items-center space-x-2 mb-1">
                            ...
                            {item.sharing_potential && item.sharing_potential > 0.5 && (
                              <Badge className="bg-orange-100/60 backdrop-blur-sm text-orange-700 border-orange-200/50 text-xs">
                                Bisa Dibagi
                              </Badge>
                            )}
                            {item.id.startsWith('manual-item') && (
                              <Badge className="bg-blue-100/60 backdrop-blur-sm text-blue-700 border-blue-200/50 text-xs">
                                Tambahan Manual
                              </Badge>
                            )}
                          </div>
                    ...
                    <GlassCard className="p-4" variant="frost" colorAccent="purple">
                          ...
                          <div key={user.id} className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              <motion.button
                                ...
                                className="w-8 h-8 rounded-lg bg-white/30 backdrop-blur-md flex items-center justify-center"
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {Object.entries(item.portions).map(([userId, portion]) => {
                            ...
                            const userObj = users.find((u) => u.id === userId)
                            return (
                              <Badge key={userId} variant="outline" className="text-xs border-purple-200/50 text-purple-700 bg-purple-50/30 backdrop-blur-sm">
        ...
        {/* Summary */}
        <GlassCard className="p-6" variant="medium" colorAccent="blue" glowEffect>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between font-bold text-lg border-t border-white/20 pt-3 text-gray-800">
            ...
            {items.some(item => item.id.startsWith('manual-item')) && (
              <>
                <div className="border-t border-dashed border-white/20 pt-3 mt-3">
                  <div className="flex items-center space-x-2 mb-2">
                    <Badge className="bg-blue-100/60 backdrop-blur-sm text-blue-700 border-blue-200/50">Item Manual</Badge>
                  ...
                  <div className="flex justify-between font-bold text-lg border-t border-white/20 pt-3 mt-2 text-gray-800">
        ...
        {/* Individual Totals */}
        <GlassCard className="p-6" variant="frost" colorAccent="cyan" glowEffect>
          <h3 className="font-semibold text-gray-800 mb-4 flex items-center justify-between">
            <span>Tagihan Individual</span>
            <Badge variant="outline" className="font-normal bg-white/20 backdrop-blur-sm border-white/30">
        ...
        {!isFinalized && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-3">
            ...
            {items.some(item => item.claimedBy.length === 0) && (
              <div className="p-3 glass-light bg-yellow-50/30 backdrop-blur-sm border border-yellow-200/50 rounded-lg text-yellow-700 text-sm">
                <div className="flex items-center space-x-2">
            ...
            <Button
              ...
              className="btn-aurora w-full flex items-center justify-center space-x-2"
            >
        ...
        <AnimatePresence>
          {isFinalized && (
            ...
            >
              {/* AI Analysis */}
              <GlassCard className="p-6" variant="medium" colorAccent="purple" glowEffect>
                <div className="flex items-center space-x-2 mb-4">
              ...
              {/* Share Options */}
              <GlassCard className="p-6" variant="light" colorAccent="blue" glowEffect>
                <div className="flex items-center space-x-2 mb-4">
